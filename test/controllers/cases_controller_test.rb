...
class CasesControllerTest < ActionController::TestCase
  ...
  test "should create case" do
    assert_difference('Case.count') do
      post :create, case: { action_plan: @case.action_plan, public_id: @case.public_id, status_id: @case.status_id }
    end
  ...
  test "should update case" do
    patch :update, id: @case, case: { action_plan: @case.action_plan, public_id: @case.public_id, status_id: @case.status_id }
    assert_redirected_to case_path(assigns(:case))
  end
